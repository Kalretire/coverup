...
public class resttemplate {
    ...
    private final String url = "http://192.168.0.14:5000/submit";
    ...
    public RedirectView requestToFlasker2(String fileName, HttpServletResponse responser, @RequestParam("file") MultipartFile files) throws Exception {
